...
LOCK TABLES `saved_address` WRITE;
/*!40000 ALTER TABLE `saved_address` DISABLE KEYS */;
INSERT INTO `saved_address` VALUES (1,1,'mohit dsfsafd','6268233693','sdfasfasf','in','216');
/*!40000 ALTER TABLE `saved_address` ENABLE KEYS */;
UNLOCK TABLES;
